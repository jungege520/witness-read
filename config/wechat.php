...
return [
     ...
     */
    'app_id'  => env('WECHAT_APPID', 'wx3f37b98cf00ee980'),         // AppID
    'secret'  => env('WECHAT_SECRET', '102293b55bc0edd4a0f73830729b0eb2'),     // AppSecret
    'token'   => env('WECHAT_TOKEN', 'huoniaojungege'),          // Token
    'aes_key' => env('WECHAT_AES_KEY', 'g3GuYayOMPdLn5Ww0myk6HbrXG1ZfLYELQhI51fWKJP'),                    // EncodingAESKey
     ...
     */
     'oauth' => [
         ...
         'callback' => env('WECHAT_OAUTH_CALLBACK', '/wechat/authCallback'),
     ],
